 ...
 */
class getLivresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LivresRepository' shared autowired service.
     *
     * @return \App\Repository\LivresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LivresRepository.php';

        return $container->privates['App\\Repository\\LivresRepository'] = new \App\Repository\LivresRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
