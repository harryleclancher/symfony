...
class __TwigTemplate_a191634c9154647eb2a13bb842414b01 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"Welcome\">
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "user", [], "any", false, false, false, 14)) {
            ...
            echo " vous êtes un ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "user", [], "any", false, false, false, 15), "roles", [], "any", false, false, false, 15), 0, [], "array", false, false, false, 15), "html", null, true);
            echo "</p>
        <ul>
            <li><a href=\"/profil/view/";
            // line 17
            ...
            <li><a href=\"/magasin/listProd\">Liste des produits</a></li>
            <li><a>Mon Panier</a></li>
            <li><a href=\"/profil/list\">Gestion utilisateur</a></li>
            <li><a href=\"/magasin/add\">Ajout Produit</a></li>
            <li><a href=\"/logout\">Déconnexion</a></li>
        </ul>
    ";
        } else {
            // line 25
            echo "        <p>Bonjour, bienvenue sur le site EH Industry, vous êtes un anonyme </p>
        <p><a href=\"security/login\">Se connecter</a></p>
    ";
        }
        // line 28
        echo "</div>
";
    ...
    {
        return array (  126 => 28,  121 => 25,  110 => 17,  102 => 15,  100 => 14,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"Welcome\">
    ...
    {% if app.user %}
        <p>Bonjour {{ app.user.prenom }} vous êtes un {{ app.user.roles[0] }}</p>
        <ul>
            <li><a href=\"/profil/view/{{ app.user.id }}\">Mon Profil</a></li>
            <li><a href=\"/magasin/listProd\">Liste des produits</a></li>
            <li><a>Mon Panier</a></li>
            <li><a href=\"/profil/list\">Gestion utilisateur</a></li>
            <li><a href=\"/magasin/add\">Ajout Produit</a></li>
    ...
    {% else %}
        <p>Bonjour, bienvenue sur le site EH Industry, vous êtes un anonyme </p>
        <p><a href=\"security/login\">Se connecter</a></p>
    {% endif %}
</div>
{% endblock %}
", "accueil/index.html.twig", "C:\\Users\\harry\\OneDrive\\Documents\\programation\\Symfony\\projet\\templates\\accueil\\index.html.twig");
    }
}
